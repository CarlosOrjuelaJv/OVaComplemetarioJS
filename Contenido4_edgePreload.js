...
if(document.addEventListener ){ 
   ...
   aLoader = [
      ...
      { load: "Contenido4_edge.js"},
      { load: "Contenido4_edgeActions.js"}];
...
var plSTF="none",ctrPlS="none",minPlW="0",maxPlW=undefined,plWidth="1024px",plHeight="644px";
...
preContent={
    dom: [
    {
        ...
        type: 'image',
        tag: 'img',
        rect: ['405px', '185px','236px','236px','auto', 'auto'],
